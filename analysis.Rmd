...
# split by sex, age, diagnosis?
t <- as.data.frame(table(sim_av_tumour$PATIENTID))
hist(t$Freq)
max(t$Freq)
...
# explore breastcancer patients?
# SELECT COUNT(DISTINCT PATIENTID) FROM SIM_AV_TUMOUR
# WHERE SITE_ICD10_O2_3CHAR=’C50′

# examine deaths by ethnicity for a certain illness (e.g. lung cancer across ethnicity, deaths across ethnicity)
