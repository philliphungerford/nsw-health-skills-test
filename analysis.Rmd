...
p <- ggplot(data = subset(non_british_males, !is.na(non_british_males$ETHNICITY)), aes(x = ETHNICITY, fill=ETHNICITY)) + 
  geom_bar() + labs(x = "Ethnicities", y = "Count (N)", title = " Count of Ethnicities in Simulacrum") + scale_fill_discrete(name = "Ethnicity") + theme(legend.position = "none")
...
ggplot(data = subset(non_british_males,!is.na(non_british_males$ethnicity_grouped)), aes(x = ethnicity_grouped, fill=ethnicity_grouped)) + 
  geom_bar() + coord_flip() + labs(x = "Ethnicity Grouped", y = "Count (N)", title = " Count of Ethnicities in Simulacrum") + scale_fill_discrete(name = "Ethnicity Grouped") 
```
